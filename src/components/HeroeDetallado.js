          ...
          <div class="card-body">
            <div class="d-flex flex-column align-items-center text-center">
              ...
              <div class="mt-3">
                ...
                {equipo.some(
                  (x) =>
                    x.biography["full-name"] === heroe.biography["full-name"] &&
                    x.name === heroe.name
                ) ? (
                  <button
            ...
            <hr />
            <div>
              <strong>Peso</strong>: {totalKilos.toFixed(2)} Kg,{" "}
              {totalLibras.toFixed(2)} Lb
            </div>
            <div>
              <strong>Altura</strong>: {totalAlturaCm.toFixed(2)} CM,{" "}
              {totalAlturaPies.toFixed(2)} pies
            </div>
          </div>
        </div>
      </span>
